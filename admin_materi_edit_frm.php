                        ...
                        <form method="post" action="admin_materi_edit_frm.php">
                            ...
                            <fieldset>
                                ...
                                <label>ID Materi</label>
                               	<input name="id_materi" type="text" class="input-block-level" maxlength="10" required="required" readonly="readonly" 
                                	value="<?php echo $row['id_materi']; ?>">
                                <label>Judul</label>
                               	<input name="judul" type="text" placeholder="Isi Judul Materi" class="input-block-level" maxlength="35" required="required" 
                                ...
                                <input name="materi" type="text" placeholder="Materi" class="input-block-level" maxlength="100" 
                                	value="<?php echo $row['materi']; ?>" required="required" readonly="readonly">								
                                <label>Materi Video</label>
                                <input name="video" type="text" placeholder="Video" class="input-block-level" maxlength="15" 
                                	value="<?php echo $row['video']; ?>" required="required" readonly="readonly" >
