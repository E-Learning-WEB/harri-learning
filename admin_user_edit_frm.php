                        ...
                        <form method="post" action="admin_user_edit_frm.php">
                            ...
                            <fieldset>
                                ...
                                <label>Username</label>
                               	<input name="id_anggota" type="text" class="input-block-level" maxlength="10" required="required" readonly="readonly" 
								...
								<label>Foto</label>
                                <input name="foto" type="text" class="input-block-level"
                                	maxlength="50" value="<?php echo $row['foto']; ?>">
                            </div><br />
