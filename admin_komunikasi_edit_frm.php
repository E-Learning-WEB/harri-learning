...
<div class="row">
    ...
    <label>Status</label>
    <input name="status" type="text" class="input-block-level" maxlength="1" value="<?php echo $row['status']; ?>">
    <label>ID Komentar</label>
    <input name="id_komentar" type="text" class="input-block-level" maxlength="10" 
    	value="<?php echo $row['id_komentar']; ?>">								
